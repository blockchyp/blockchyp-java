 ...
 */
public class TransactionStatusRequest implements ITimeoutRequest, ICoreRequest {
     ...
     * @param value the BlockChyp assigned transaction id.
     */
     ...
     * @return the BlockChyp assigned transaction id.
     */

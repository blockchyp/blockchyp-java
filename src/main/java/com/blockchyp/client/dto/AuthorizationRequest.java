...
/**
 * models auth requests for charge, preauth, and reverse transaction types.
 */
...
public class AuthorizationRequest implements ICoreRequest, ITerminalReference, IPaymentMethod, IRequestAmount, ISubtotals, ISignatureRequest, IPreviousTransaction {
     ...
     /**
      * is used to validate online gift card authorizations.
      */
     ...
     /**
      * adds the payment method to the token vault alongside the authorization.
      */

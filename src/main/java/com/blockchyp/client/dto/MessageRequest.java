 ...
 */
public class MessageRequest implements ITimeoutRequest, ICoreRequest, ITerminalReference {
     ...
     * @param value the message to be displayed on the terminal.
     */
     ...
     * @return the message to be displayed on the terminal.
     */

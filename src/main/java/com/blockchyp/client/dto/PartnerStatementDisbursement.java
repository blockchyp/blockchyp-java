...
public class PartnerStatementDisbursement {
    ...
    /**
     * Sets the disbursement id.
     * @param value the disbursement id.
     */
    ...
    /**
     * Sets date and time the disbursement was processed.
     * @param value date and time the disbursement was processed.
     */

 ...
 */
public class MerchantPlatformRequest implements ITimeoutRequest, ICoreRequest {
     ...
     * @param value the platform configuration id.
     */
     ...
     * @return the platform configuration id.
     */

...
public class PanChargeTest extends BaseTestCase {
    ...
    public void testEndpoint() throws Exception {
        ...
        processTestDelay(IntegrationTestConfiguration.getTestClient(), "PANChargeTest", IntegrationTestConfiguration.getDefaultTerminalName());

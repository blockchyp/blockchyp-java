...
public class TerminalBrandingTest extends BaseTestCase {
    ...
    public void testTransaction() throws Exception {
        ...
        processTestDelay(client, "TerminalBrandingTest", IntegrationTestConfiguration.getDefaultTerminalName());

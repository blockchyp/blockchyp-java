...
public class MerchantPlatformsTest extends BaseTestCase {
    ...
    public void testTransaction() throws Exception {
        ...
        processTestDelay(client, "MerchantPlatformsTest", IntegrationTestConfiguration.getDefaultTerminalName());

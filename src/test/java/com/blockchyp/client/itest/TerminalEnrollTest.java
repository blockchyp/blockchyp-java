...
public class TerminalEnrollTest extends BaseTestCase {
    ...
    public void testEndpoint() throws Exception {
        ...
        processTestDelay(IntegrationTestConfiguration.getTestClient(), "TerminalEnrollTest", IntegrationTestConfiguration.getDefaultTerminalName());
